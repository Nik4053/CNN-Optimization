...
template __global__ void  w_shfl_registers_reordered_padded_work<3,1>(Tensor<float, 4> inputPadded, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_shfl_registers_reordered_padded_work<3,2>(Tensor<float, 4> inputPadded, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_shfl_registers_reordered_padded_work<3,4>(Tensor<float, 4> inputPadded, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_shfl_registers_reordered_padded_work<3,8>(Tensor<float, 4> inputPadded, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_shfl_registers_reordered_padded_work<3,16>(Tensor<float, 4> inputPadded, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_shfl_registers_reordered_padded_work<3,32>(Tensor<float, 4> inputPadded, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);