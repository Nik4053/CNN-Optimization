...
template __global__ void  w_work_shfl<3,1>(Tensor<float, 4> input, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_work_shfl<3,2>(Tensor<float, 4> input, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_work_shfl<3,4>(Tensor<float, 4> input, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_work_shfl<3,8>(Tensor<float, 4> input, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_work_shfl<3,16>(Tensor<float, 4> input, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);
template __global__ void  w_work_shfl<3,32>(Tensor<float, 4> input, Tensor<float, 4> error, Tensor<float, 4> gradient_weights);